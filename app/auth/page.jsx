...
export default function AuthPage() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col items-center justify-center p-8">
      ...
      <div className="border-4 border-blue-500 rounded-lg p-8 bg-white shadow-lg">
        {/* Logo */}
        <div className="mb-8 text-center">
          <div className="flex items-center justify-center mb-2">
            ...
            <div className="ml-3">
              <span className="text-2xl font-bold text-blue-800">HireQ</span>
        ...
        <div className="bg-blue-50 border border-blue-100 rounded-lg p-8 mb-8 max-w-2xl w-full mx-auto">
        ...
        <button
          ...
          className="flex items-center space-x-3 bg-white border-2 border-gray-300 rounded-lg px-6 py-3 hover:border-gray-400 hover:shadow-md transition-all duration-200 mx-auto"
        >
